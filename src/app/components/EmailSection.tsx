...
const EmailSection = () =>{
    ...
    return(
        <section id='contact' className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative'>
            ...
            "Thank you for visiting my portfolio! I'm always open to discussing new opportunities, collaborations, or just connecting with like-minded individuals. If you have any questions or would like to work together, please feel free to reach out. I look forward to hearing from you!"
            </p>
